  ...
  return (
    <div className="relative">
      ...
      <div className="absolute bottom-0 w-full flex items-center justify-center z-[1] xl:hidden">
        <RedesSociales
          iconClassName={"fill-white w-10 h-10 md:w-14 md:h-14"}
          hideText={true}
        />
      </div>
      <img
        className="presentation-img w-full object-cover object-center"
        src="/images/principal.webp"
        alt="Foto principal de presentacion pizzeria junkal irun"
      />
      <div className="w-full h-60 presentation-shadow absolute bottom-0"></div>
    </div>
  );
};
