        ...
        <>
            ...
            <header className="fixed" >
                <div className={`${scrolled ? '-translate-y-10 md:-translate-y-12' : 'translate-y-0 '} transition transform duration-300`}>
                    ...
                    <div className={`flex transition duration-300 justify-between items-center px-4 md:px-12 py-2 md:py-4 pb-8 `}>
                        <div>
            ...
            <a href="tel:943265863" className={`${scrolled ? 'translate-x-0' : 'translate-x-24'} md:hidden flex items-center justify-center fixed bottom-12 right-8 w-12 h-12 rounded-full bg-green-500 z-50 shadow-md shadow-gray-600 transition transform duration-300 active:bg-green-700 active:shadow-sm active:shadow-gray-400 `}>
