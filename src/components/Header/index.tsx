...
const Header = () => {
    ...
    const scrollToSection = (sectionId: string, offset?: number) => {
        ...
        if (anchor) {
            const y = anchor.getBoundingClientRect().top + window.scrollY - (offset ?? 0);
